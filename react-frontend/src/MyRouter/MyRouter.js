...
import SingleTeachersPage from "../components/app_components/TeachersPage/SingleTeachersPage";
import TeacherProjectLayoutPage from "../components/app_components/TeachersPage/TeacherProjectLayoutPage";
import SingleStudentsGradesPage from "../components/app_components/StudentsGradesPage/SingleStudentsGradesPage";
import StudentsGradeProjectLayoutPage from "../components/app_components/StudentsGradesPage/StudentsGradeProjectLayoutPage";
import SingleSubjectsPage from "../components/app_components/SubjectsPage/SingleSubjectsPage";
import SubjectProjectLayoutPage from "../components/app_components/SubjectsPage/SubjectProjectLayoutPage";
import SingleClassesPage from "../components/app_components/ClassesPage/SingleClassesPage";
import ClassProjectLayoutPage from "../components/app_components/ClassesPage/ClassProjectLayoutPage";
//  ~cb-add-import~
...
<Route path="/teachers/:singleTeachersId" exact element={<SingleTeachersPage />} />
<Route path="/teachers" exact element={<TeacherProjectLayoutPage />} />
<Route path="/studentsGrades/:singleStudentsGradesId" exact element={<SingleStudentsGradesPage />} />
<Route path="/studentsGrades" exact element={<StudentsGradeProjectLayoutPage />} />
<Route path="/subjects/:singleSubjectsId" exact element={<SingleSubjectsPage />} />
<Route path="/subjects" exact element={<SubjectProjectLayoutPage />} />
<Route path="/classes/:singleClassesId" exact element={<SingleClassesPage />} />
<Route path="/classes" exact element={<ClassProjectLayoutPage />} />
